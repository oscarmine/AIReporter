                ...
                <div className="max-w-xl space-y-8">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-xs text-white/50 hover:text-white hover:bg-white/10 transition-colors"
                                    >
                                        {showApiKey ? '🙈' : '👁️'}
                                    </button>
                                </div>
                                <p className="text-[10px] text-white/30 mt-1">
                                    Note: This key is stored locally in your browser. For production, configure in .env file.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="bg-white/5 rounded-lg p-4 text-sm text-white/70">
                            <p className="font-medium text-white">AI Report Generator</p>
                            <p className="text-xs text-white/50 mt-1">Version 1.0.0</p>
                            <p className="mt-3 text-xs text-white/40">
                                Generate professional security reports from raw findings using Google Gemini AI.
                            </p>
                        </div>
                    </section>
